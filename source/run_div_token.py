...
def subword2token_labels(
    args, output_test_predictions_file, predictions, tokenizer, mode="Test"
):
...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for id_, checkpoint in enumerate(checkpoints):
            ...
            output_dev_predictions_file = os.path.join(
                args.output_dir, "dev_predictions.txt"
            )
            result = subword2token_labels(
                args, output_dev_predictions_file, predictions, tokenizer, mode="dev"
            )
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        result, predictions = evaluate(
            args, model, tokenizer, labels, pad_token_label_id, mode="test_synth"
        )
